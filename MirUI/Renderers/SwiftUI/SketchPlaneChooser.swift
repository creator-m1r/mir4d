...
/// Оверлей выбора плоскости построения эскиза.
///
/// Показывается при входе в режим эскиза до выбора плоскости. После выбора
/// вызывается `onPick`, который анкерит эскиз к плоскости, плавно поворачивает
/// камеру перпендикулярно плоскости и активирует прозрачную рабочую плоскость.
