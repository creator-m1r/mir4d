...
struct MIR4DStartupView: View {
    ...
    @StateObject private var boot =
        MIR4DBootCoordinator()
    ...
    private var bootFailureView: some View {
        ...
        VStack(spacing: 24) {
            ...
            Text(
                "MIR 4D не может продолжить запуск"
            )
            .font(
                .system(
                    size: 25,
